...
if __name__ == "__main__":
    render_path = f'{WORKSPACE_DIR}/data/render_eval_data'
    human_mask_path = f"{WORKSPACE_DIR}/data/different_types_human_mask"
    root_data_dir = f'{WORKSPACE_DIR}/data/gaussian_data'
    output_dir = f'{WORKSPACE_DIR}/gaussian_output_dynamic'
