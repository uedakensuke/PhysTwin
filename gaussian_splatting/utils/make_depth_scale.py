...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_dir', default="../../mount/data/data/big_gaussians/standalone_chunks/campus")
    parser.add_argument('--depths_dir', default="../../mount/data/data/big_gaussians/standalone_chunks/campus/depths_any")
